//expo install @react-native-async-storage/async-storage react-native-paper react-native-vector-icons
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        placeholder="タスク名を入力"
      />
      <Button mode="contained" style={styles.addButton} onPress={addTask}>
        タスク追加
      </Button>
